defmodule FootyPintWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FootyPintWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FootyPintWeb.Gettext, "errors", msg, opts)
    end
  end
